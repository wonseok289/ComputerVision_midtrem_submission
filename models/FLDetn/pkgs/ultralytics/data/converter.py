...
def convert_coco(labels_dir='../coco/annotations/', use_segments=False, use_keypoints=False, cls91to80=True):
    ...
    Example:
        ```python
        from models.FLDetn.pkgs.ultralytics.data.converter import convert_coco
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Example:
        ```python
        from models.FLDetn.pkgs.ultralytics.data.converter import convert_dota_to_yolo_obb
