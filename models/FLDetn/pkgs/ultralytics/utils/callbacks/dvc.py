...
from models.FLDetn.pkgs.ultralytics.utils import LOGGER, SETTINGS, TESTS_RUNNING
...
def on_fit_epoch_end(trainer):
    ...
    if live and _training_epoch:
        ...
        if trainer.epoch == 0:
            from models.FLDetn.pkgs.ultralytics.utils.torch_utils import model_info_for_loggers
