...
from models.FLDetn.pkgs.ultralytics.utils.metrics import OKS_SIGMA, PoseMetrics, box_iou, kpt_iou
...
class PoseValidator(DetectionValidator):
    ...
    Example:
        ```python
        from models.FLDetn.pkgs.ultralytics.models.yolo.pose import PoseValidator
